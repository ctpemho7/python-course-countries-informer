...
Клонируйте репозиторий проекта в свою рабочую директорию:
    ...
    .. code-block:: console
        ...
        git clone https://github.com/ctpemho7/python-course-country-directory.git
...
1. Скопируйте файл настроек `.env.sample`, создав файл `.env`:
    ...
    * NewsAPI - API для получения новостей (https://newsapi.org/)
...
3. Теперь возможно запустить приложение в контейнере:
    .. code-block:: console
...
4. Для корректной работы приложения настройте базу данных с помощью команд.
